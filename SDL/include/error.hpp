...
namespace sdl
{
    namespace error
    {
        ...
        bool sdl(int result, const std::source_location &location = std::source_location::current());

        /// @brief Records a freetype error.
        /// @param result Result of the freetype function.
        /// @param location Optional. Records location.
        bool freetype(int result, const std::source_location &location = std::source_location::current());

        /// @brief Records a libnx error to string.
        /// @param result Result to record.
        /// @param location Source location.
        bool libnx(Result result, const std::source_location &location = std::source_location::current());
